...
bool operator ==(Object other) {
  return identical(this, other) || (other.runtimeType == runtimeType&&other is SessionState&&(identical(other.appUser, appUser) || other.appUser == appUser));
}
...
@override
String toString() {
  return 'SessionState(appUser: $appUser)';
}
...
@optionalTypeArgs TResult maybeWhen<TResult extends Object?>(TResult Function( AppUser? appUser)?  $default,{required TResult orElse(),}) {final _that = this;
switch (_that) {
case _SessionState() when $default != null:
return $default(_that.appUser);case _:
  return orElse();
...
@optionalTypeArgs TResult when<TResult extends Object?>(TResult Function( AppUser? appUser)  $default,) {final _that = this;
switch (_that) {
case _SessionState():
return $default(_that.appUser);case _:
  throw StateError('Unexpected subclass');
...
@optionalTypeArgs TResult? whenOrNull<TResult extends Object?>(TResult? Function( AppUser? appUser)?  $default,) {final _that = this;
switch (_that) {
case _SessionState() when $default != null:
return $default(_that.appUser);case _:
  return null;
...
class _SessionState extends SessionState {
  const _SessionState({this.appUser}): super._();
...
@override
bool operator ==(Object other) {
  return identical(this, other) || (other.runtimeType == runtimeType&&other is _SessionState&&(identical(other.appUser, appUser) || other.appUser == appUser));
}
